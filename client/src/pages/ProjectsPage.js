      ...
      <div className="Projectpage">
        <div className="heroProjects">
            ...
            <Grid container spacing={16}>
              ...
              <Grid className="foreground-parallax" id="foreground-parallax-mobile" container spacing={24}>
                ...
                <Grid item xs={10}>
                  ...
                  <Grid container spacing={8} direcion="row" justify="center" alignItems="center">
